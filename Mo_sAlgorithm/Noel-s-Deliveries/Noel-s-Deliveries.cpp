/*
	...
	Problem: Noel's Deliveries
	Link: https://www.urionlinejudge.com.br/judge/en/problems/view/2476
	Origin: Christmas Contest 2016.
*/
#include <bits/stdc++.h>
using namespace std;
...
int lca(int u, int v) {
	...
	for (int i = L; i >= 0; --i) if (!is_anc(anc[v][i], u)) v = anc[v][i];
	return anc[v][0];
}
//-------- FIM LCA ----------
