/*
	...
	Problem: Mathematicians Needed in Mars
	Link: https://www.urionlinejudge.com.br/judge/en/problems/view/1804
	Origin: Official Contest of Heating of the Brazilian Computer Olympics 2015
*/
#include <bits/stdc++.h>
using namespace std;
